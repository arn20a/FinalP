...
public final class BinaryStdIn {
     ...
     * @throws RuntimeException if there are fewer than 8 bits available on standard
     *                          input
     */
     ...
     * @throws RuntimeException if there are fewer than 16 bits available on
     *                          standard input
     */
     ...
     * @throws RuntimeException if there are fewer than 64 bits available on
     *                          standard input
     */
