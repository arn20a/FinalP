...
public final class BinaryIn {
    ...
    /**
     * Read the next bit of data from the binary input stream and return as a
     * boolean.
     * 
     * @return the next bit of data from the binary input stream as a
     *         <tt>boolean</tt>
    ...
    /**
     * Read the next 8 bits from the binary input stream and return as an 8-bit
     * char.
     * 
     * @return the next 8 bits of data from the binary input stream as a
     *         <tt>char</tt>
    ...
    /**
     * Read the next r bits from the binary input stream and return as an r-bit
     * character.
     * 
     * @param r number of bits to read.
     * @return the next r bits of data from the binary input streamt as a
     *         <tt>char</tt>
    ...
    /**
     * Read the remaining bytes of data from the binary input stream and return as a
     * string.
     * 
     * @return the remaining bytes of data from the binary input stream as a
     *         <tt>String</tt>
     * @throws RuntimeException if the input stream is empty or if the number of
     *                          bits
    ...
    /**
     * Read the next 16 bits from the binary input stream and return as a 16-bit
     * short.
     * 
     * @return the next 16 bits of data from the binary standard input as a
     *         <tt>short</tt>
    ...
    /**
     * Read the next 32 bits from the binary input stream and return as a 32-bit
     * int.
     * 
     * @return the next 32 bits of data from the binary input stream as a
     *         <tt>int</tt>
     ...
     * 
     * @param r number of bits to read.
     * @return the next r bits of data from the binary input stream as a
     *         <tt>int</tt>
     * @throws RuntimeException if there are fewer than r bits available on standard
     *                          input
     */
    ...
    /**
     * Read the next 64 bits from the binary input stream and return as a 64-bit
     * long.
     * 
     * @return the next 64 bits of data from the binary input stream as a
     *         <tt>long</tt>
     ...
     * @throws RuntimeException if there are fewer than 32 bits available on
     *                          standard input
     */
